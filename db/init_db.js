...
async function populateInitialData() {
  ...
  try {
    ...
    const albumsToCreate = [
      {artist: 'CHARLIE WORSHAM', title:'SUGARCANE', description: 'COUNTRY', price: 25, qty: ''},
      {artist: ' DAN + SHAY', title:'GOOD THINGS', description: 'COUNTRY', price: 35, qty: ''},
      {artist: 'MIDLAND', title:'THE LAST RESORT', description: 'COUNTRY', price: 30, qty: ''},
